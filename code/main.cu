...
#define WEAK_SCALING_IMAGES_PER_RANK 100  // In weak scaling, each rank processes this many images
...
int main(int argc, char** argv) {
    ...
    int images_per_rank = weak_scaling ? WEAK_SCALING_IMAGES_PER_RANK : 6400 / size;
